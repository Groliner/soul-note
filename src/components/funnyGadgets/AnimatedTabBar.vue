<!--
 * @Author: Gro lin
 * @Date: 2024-09-12 22:28:58
 * @LastEditors: Gro lin
 * @LastEditTime: 2024-09-12 22:49:24
-->
<script setup>
import { onMounted } from 'vue'
import { PhMagnifyingGlassPlus } from '@phosphor-icons/vue'
onMounted(() => {
  const body = document.querySelector('.container-animated-tab-bar')
...
<template>
  <div class="container-animated-tab-bar">
    <menu class="menu">
      <button class="menu__item active" style="--bgColorItem: #ff8c00">
        ...
        <PhMagnifyingGlassPlus class="icon" :size="32" weight="bold" />
      </button>
